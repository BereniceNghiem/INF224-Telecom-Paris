\hypertarget{classSocketBuffer}{}\doxysection{Référence de la classe Socket\+Buffer}
...
Graphe de collaboration de Socket\+Buffer\+:
% FIG 0
...
Reads exactly {\itshape len} bytes from the socket, blocks otherwise. \begin{DoxyReturn}{Renvoie}
...
Writes {\itshape len} bytes to the socket. \begin{DoxyReturn}{Renvoie}
see \mbox{\hyperlink{classSocketBuffer_afa3a2f239eb56c2e4fd4fa465f7fb54d}{read\+Line()}} 
\end{DoxyReturn}
