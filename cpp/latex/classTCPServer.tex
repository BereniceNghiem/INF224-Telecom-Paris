\hypertarget{classTCPServer}{}\doxysection{Référence de la classe TCPServer}
...
Starts the server. Binds an internal \mbox{\hyperlink{classServerSocket}{Server\+Socket}} to {\itshape port} then starts an infinite loop that processes connection requests from clients. \begin{DoxyReturn}{Renvoie}
